...
const DeleteBugConfirmModal = ({ bug, onConfirm, onClose }) => {
    console.log(bug);
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md">
        ...
        <div className="p-6">
          <p className="mb-6 dark:text-gray-300 text-gray-700">
            Are you sure you want to delete bug <span className="font-bold">{bug.id}</span> for <span className="font-bold">{bug.clientName}</span>? This action cannot be undone.
          </p>
...
export default DeleteBugConfirmModal;